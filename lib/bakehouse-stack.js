...
export class BakehouseStack extends Stack {
  constructor(scope, id, props) {
    ...
    const role = new iam.Role(this, 'GitHubActionsRole', {
      roleName: `github-actions-${props.stackName}-${props.githubRepo}`,
        ...
        provider.openIdConnectProviderArn,
        {
          ...
          StringLike: {
            'token.actions.githubusercontent.com:sub': [
              `repo:${props.githubOrg}/${props.githubRepo}:${props.githubRefFilter}`,
    ...
    // add admin access policy to role
    ...
    // Grant lambdas to access DynamoDB
    usersTable.grantWriteData(postUsersLambda)
